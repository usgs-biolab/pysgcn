...
def process_1(
    ...
    test_data = (("North Carolina", "2015"), ("North Dakota", "2015"), ("Ohio", "2015"), ("Oklahoma", "2015"), ("Oregon", "2015"))
...
def process_2(
    ...
    #testSpecies = ["Eleutherodactylus wightmanae", "Anguilla rostrata", "Eleotris amblyopsis"]
